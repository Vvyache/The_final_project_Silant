...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        file_path = os.path.join(current_directory + '/main/management/commands/', 'cars_lookups.txt')  # Путь к файлу lookups.txt в текущей директории
