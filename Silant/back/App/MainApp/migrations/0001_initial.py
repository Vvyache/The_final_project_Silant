    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='handbook_client', to=settings.AUTH_USER_MODEL, verbose_name='Покупатель')),
                ...
                ('modelOfMachine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='handbook_modelOfMachine', to='Handbook.modelofmachine', verbose_name='Модель машины')),
